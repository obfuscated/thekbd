...
extern const uint8_t layoutTable[keysTotalNumber]={
    ...
    // row 4 right
    HID_KEYBOARD_LEFT_BRACKET_AND_LEFT_CURLY_BRACE, HID_KEYBOARD_P_AND_P, HID_KEYBOARD_O_AND_O, HID_KEYBOARD_I_AND_I,
    ...
    // row  5 right
    HID_KEYBOARD_RIGHT_BRACKET_AND_RIGHT_CURLY_BRACE, HID_KEYBOARD_EQUALS_AND_PLUS, HID_KEYBOARD_MINUS_AND_UNDERSCORE,
