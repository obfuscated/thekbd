...
extern const uint8_t layoutTable[keysTotalNumber]={
    ...
    // row 1 right
    HID_KEYBOARD_RIGHT_ALT, 0,   0, HID_KEYBOARD_UP_ARROW, 0, HID_KEYBOARD_ENTER, HID_KEYBOARD_DELETE,
    // row 1 left
    ...
    // row 3 left
    HID_KEYBOARD_LEFT_BRACKET_AND_LEFT_CURLY_BRACE, HID_KEYBOARD_G_AND_G, HID_KEYBOARD_F_AND_F,
    HID_KEYBOARD_D_AND_D, HID_KEYBOARD_S_AND_S, HID_KEYBOARD_A_AND_A, HID_KEYBOARD_LEFT_SHIFT,

    // row 4 right
    0, HID_KEYBOARD_P_AND_P, HID_KEYBOARD_O_AND_O, HID_KEYBOARD_I_AND_I, HID_KEYBOARD_U_AND_U,
    HID_KEYBOARD_Y_AND_Y, HID_KEYBOARD_BACKSLASH_AND_PIPE,
    // row 4 left
    HID_KEYBOARD_RIGHT_BRACKET_AND_RIGHT_CURLY_BRACE, HID_KEYBOARD_T_AND_T, HID_KEYBOARD_R_AND_R,
    HID_KEYBOARD_E_AND_E, HID_KEYBOARD_W_AND_W, HID_KEYBOARD_Q_AND_Q, HID_KEYBOARD_TAB,

    // row  5 right
    0, HID_KEYBOARD_EQUALS_AND_PLUS, HID_KEYBOARD_MINUS_AND_UNDERSCORE, HID_KEYBOARD_0_AND_RIGHT_PAREN,
    HID_KEYBOARD_9_AND_LEFT_PAREN, HID_KEYBOARD_8_AND_ASTERISK, HID_KEYBOARD_7_AND_AMPERSAND,
    // row 5  left
